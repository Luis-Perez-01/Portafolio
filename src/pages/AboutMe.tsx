...
export default function AboutMe() {
  return (
    <section
      ...
      id="about"
    >
      <article className="grid grid-cols-1 md:grid-cols-6 place-content-center items-center bg-gray-100 dark:bg-gray-900/20 rounded-lg animate-fade-up gap-4 p-6">
        <hgroup className="md:col-span-4 leading-6">
      ...
      <article className="grid relative place-content-center bg-gray-100 dark:bg-gray-900/20 rounded-lg p-6">
